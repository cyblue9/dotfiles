...

;;;### (autoloads nil "extempore" "extempore.el" (0 0 0 0))
;;; Generated autoloads from extempore.el

(autoload 'extempore-mode "extempore" "\
...
(autoload 'extempore-repl "extempore" "\


\(fn HOST PORT)" t nil)

(autoload 'extempore-run "extempore" "\
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "extempore" '("extempore-" "next-sexp-as-string" "note-to-midi" "hex-to-decimal-at-point" "xpb1" "switch-to-extempore" "inferior-extempore-mode" "chomp" "would-be-symbol" "user-extempore-directory")))
...
;;;***

;;;### (autoloads nil nil ("extempore-mode-pkg.el") (0 0 0 0))
